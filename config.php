<?php
   ...
   define("API_URL", "https://159c-180-183-250-244.ap.ngrok.io/security-php-ajax");
   define("CAPTCHA_URL", "https://159c-180-183-250-244.ap.ngrok.io/security-php-ajax/phptextcaptcha/phptextcaptcha/captcha.php?rand=");
   $key = "oattiz!";
   $appId = "2001";
